function zoo = limit_zoo_to_fully_validated_profiles(validated_list_file,zoo)
%FUNCTION LIMIT_ZOO_TO_FULLY_VALIDATED_PROFILES
%
%  Syntax:
%    zoo = limit_zoo_to_fully_validated_profiles(validated_list_file,zoo)
%
%  Inputs:
%   zoo                 | output from UVP_read_odv_ecotaxa_exported_zoo.m
%   validated_list_file | file name containing list of fully validated
...
%                         separated by commas. E.g. p16n_001, p16n_006,
%                         p16n_011, p16n_012
%
%  Outputs:
%   zoo                 | same format as input zoo, but contains only zoo
%                         data from fully validated profiles. 
% 
%  Description:
...
try
  ...
  fileID = fopen(validated_list_file,'r');
